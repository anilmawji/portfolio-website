  ...
  return (
    <section className={styles.bio}>
      <p>
        ...
        With hands-on experience as a systems administrator and a software developer, I'm now diving into ethical hacking as I work towards earning my PJPT from TCM Security.
