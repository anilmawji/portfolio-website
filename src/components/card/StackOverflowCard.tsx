  ...
  return (
    <a href={`https://stackoverflow.com/users/${user_id}`} target="_blank">
      <img
        ...
        width={width}
        height={height}
        alt={`Profile at Stack Overflow, a site for professional and enthusiast programmers`}
        title={`Profile at Stack Overflow, a site for professional and enthusiast programmers`}
        {...restProps}
      />
    </a>
  );
